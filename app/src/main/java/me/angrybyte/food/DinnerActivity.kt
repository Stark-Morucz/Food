...
class DinnerActivity : AppCompatActivity() {
    ...
    class DinnerAdapter(val items: ArrayList<String>, val details: ArrayList<String>, val context: Context) : RecyclerView.Adapter<DinnerActivity.DinnerAdapter.ViewHolder>() {
